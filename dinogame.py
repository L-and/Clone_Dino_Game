...
# 화면 타이틀 설정
pygame.display.set_caption("유사 공룡게임") # 게임 이름
...
while running:
    ...
    # 적 랜덤생성 
    if elapsed_time % enemy_spawn_time == 0 and spawn_cool == True:
    ...
    for idx, val in enumerate(enemys):
        ...
        screen.blit(enemy_images[enemy_img_idx], (int(enemy_pos_x), int(enemy_pos_y)))
